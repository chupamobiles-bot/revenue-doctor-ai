...
- `hero.png` — top of the site, hero + 3-options pill row
...
Then reference them in README.md like:
    ...
    ![Connect flow](screenshots/connect-flow.gif)

Use tools like:
- macOS: Cmd+Shift+5 for screen recording → convert to GIF with [Gifski](https://gif.ski/)
- Windows: ShareX (free) → record → save as GIF
